...
export default function Generator(props) {
  ...
  // whenever user interacts with a value to change content on the screen, use a stateful variable
  ...
  return (
    <SectionWrapper id={'generate'} header={'generate your workout'} title={['Ready', 'Set', 'Get Jacked']}>
      <Header index={'01'} title={'Pick Your Poison'} 
      description={'Select the workout you wish to endure'} />
    
      {
      // four of the same button -- use mapping - need an array
      // parent element needs unique key
      }
      <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            ...
            className={'bg-slate-950 px-4 border duration-200 hover:border-blue-600 py-3 rounded-lg ' 
